<template>
  ...
  <div class="navbar" :class="{ isColl: isCollapse }">
    ...
    <el-menu :router="true"
    default-active="2" class="el-menu-vertical-demo" background-color="#304156" text-color="#fff"
      :unique-opened="true" :collapse='isCollapse' :collapse-transition="false" active-text-color="#ffd04b" :default-active="$route.path">
